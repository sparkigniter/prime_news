export default function Card({title, featureImage, description, url}) {
    return (
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-2 p-2">
            <a href="#">
                <img className="rounded-t-lg" src={featureImage} alt="" />
            </a>
            <div className="p-5">
                <a href="#">
